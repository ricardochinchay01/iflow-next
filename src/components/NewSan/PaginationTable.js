            ...
            <div className="flex justify-between items-center">
                <div className="text-gray-700">
                    {paginationData.total === 0
                        ...
                        : `Mostrando ${
                          ...
                          )} de un total de ${paginationData.total}`}
                </div>
                <div className="flex items-center space-x-4">
                    <button
                        ...
                        className={`bg-blue-900 text-white px-4 py-2 rounded transition duration-300 ease-in-out ${
                            paginationData.currentPage === 1
                    ...
                    {getDisplayedPages().map(page => (
                        <button
                            ...
                            className={`px-4 py-2 mx-1 rounded transition duration-300 ease-in-out ${
