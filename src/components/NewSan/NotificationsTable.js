...
const NotificationsTable = ({ notificaciones, canViewNotificaciones, canDescargarNotificaciones, handleDownload, changeSorting, orderBy, column }) => {
    return (
        <table className="min-w-full bg-white">
            <thead className="bg-gray-800 text-white">
                <tr>
                    <th
                        className="w-1/7 text-left py-3 px-4 cursor-pointer"
                    ...
                    <th
                        className="w-2/7 text-left py-3 px-4 cursor-pointer"
            ...
            <tbody className="text-gray-700">
                {canViewNotificaciones
                    ...
                    : (
                        <tr>
                            <td colSpan={5} className="text-center py-3 px-4">No tienes permiso para ver las notificaciones</td>
                        </tr>
                    )}
            </tbody>
        </table>
