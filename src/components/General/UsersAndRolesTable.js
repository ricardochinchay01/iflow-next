        ...
        <table className="min-w-full bg-white rounded-lg overflow-hidden shadow-md">
            <thead className="bg-blue-900 text-white">
                <tr>
                    ...
                    <th
                        className="py-3 px-6 text-center w-1/12 cursor-pointer"
                    ...
                    <th
                        className="py-3 px-6 text-center w-1/4 cursor-pointer"
                                    ...
                                    {user.roles.length > 0 ? (
                                        <ul>
                                            {user.roles.map(role => (
                                                <span
                                                    key={role.id}
                                                    className="mr-2 mb-2 bg-blue-600 text-white px-4 py-1 rounded-full text-xs">
                                                    {role.name}
                                                </span>
                                            ))}
                                        </ul>
