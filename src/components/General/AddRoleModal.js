...
const AddRoleModal = ({ isOpen, onClose, isAdmin, addRoleWithPermissions }) => {
    const {
        getAllPermissions,
        addPermission,
        deletePermission,
    ...
    const handleAddPermission = async () => {
        if (newPermission) {
            ...
            const isValid = /^[A-Z][a-zA-Z]+\.[a-zA-Z]+[^-]*$/.test(
                newPermission,
            )

            if (!isValid) {
                toast.error(
                    'Formato de permiso inválido. Se debe ingresar el nombre del modulo, seguido de un punto y el nombre del permiso sin espacios.',
                    {
            ...
            try {
                ...
                toast.error(
                    'Error al crear el permiso. Por favor, intenta de nuevo.',
                    {
                        position: toast.POSITION.BOTTOM_RIGHT,
                    },
                )
        ...
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center z-50">
            ...
            <div className="bg-white w-3/4 max-w-xl rounded p-4 z-10">
                ...
                <p className="text-xs text-gray-500 mb-2">
                    Ingresar nombre del rol y los permisos para los distintos
                    módulos.
                </p>
                <ValidatedInput
                    id="roleNameInput"
                ...
                />
                <div>
                    {Object.entries(organizedPermissions).map(
                ...
                <div className="flex items-center mb-4 mt-4">
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-2">
                            Ingresar nombre del módulo seguido de un punto, sin
                            espacios, seguido del nombre del permiso.
                        </p>
                    </div>
                </div>
